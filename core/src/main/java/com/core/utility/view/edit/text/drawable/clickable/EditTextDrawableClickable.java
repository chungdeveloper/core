...
public class EditTextDrawableClickable extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public EditTextDrawableClickable(Context context, AttributeSet attrs, int defStyle) {
